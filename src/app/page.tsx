  ...
  return (
    <main className="container mx-auto p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Link 
          href="/analyzers/tuner" 
          className="p-6 bg-white border rounded-lg shadow-md hover:shadow-lg transition-shadow"
        >
          <h3 className="text-xl font-semibold mb-2">Тюнер инструментов</h3>
          <p className="text-gray-600">
            Настраивайте музыкальные инструменты в реальном времени с помощью 
            микрофона. Определяйте высоту звука и видите, насколько точно 
            настроена нота относительно эталонной частоты.
          </p>
        </Link>
      </div>
    </main>
